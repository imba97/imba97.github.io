...
<div class="tpl works" id="_worksJpinput">
  ...
  <div class="c-body">
    ...
    <p class="img_p"><a class="img" data-name="jpinput_1.gif" href="javascript:;"></a></p>
    ...
    <p class="img_p"><a class="img" data-name="jpinput_2.gif" href="javascript:;"></a></p>
    <p class="text">新版本提醒实现原理只是AJAX请求发送给服务器，服务器获取数据库最新的版本号和更新内容并返回。</p>
    <p class="text">自动加载jQuery：</p>
    <p class="img_p"><a class="img" data-name="jpinput_3.gif" href="javascript:;"></a></p>
