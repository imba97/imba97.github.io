...
<div class="tpl works" id="_worksSwitch">
  <div class="c-header">
    <ul>
      <li>项目名称：Switch关灯工具</li>
  ...
  <div class="c-body">
    ...
    <img src="./images/switch_1.gif">
    <p class="text">原文章有些图片不太能拿出手，就是那个“蒜头鼻”，发个链接好了。点<a href="http://t.cn/EZd6NhZ">这里</a>。</p>
    <div class="bg"></div>
  </div>
</div>
<script>
