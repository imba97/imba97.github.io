...
from：https://codepen.io/electro-z/pen/JQyovo
...
function fn() {
    ...
    var canvas = document.getElementById('bgCanvas'), ctx = canvas.getContext('2d'), w = canvas.width = window.innerWidth, h = canvas.height = window.innerHeight, hue = 217, stars = [], count = 0, maxStars = 1200;
